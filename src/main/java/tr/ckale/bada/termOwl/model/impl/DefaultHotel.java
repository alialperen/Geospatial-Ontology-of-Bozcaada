...
public class DefaultHotel extends WrappedIndividualImpl implements Hotel {
    ...
    public Collection<? extends Object> getHasStar() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSTAR, Object.class);
    }

    public boolean hasHasStar() {
		return !getHasStar().isEmpty();
    }

    public void addHasStar(Object newHasStar) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSTAR, newHasStar);
    }

    public void removeHasStar(Object oldHasStar) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_HASSTAR, oldHasStar);
    }
