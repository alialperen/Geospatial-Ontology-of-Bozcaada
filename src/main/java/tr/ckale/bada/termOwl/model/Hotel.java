...
public interface Hotel extends Building {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/alperen/ontologies/2016/11/geolocation#hasStar
     */
     
    /**
     * Gets all property values for the hasStar property.<p>
     * 
     * @returns a collection of values for the hasStar property.
     */
    Collection<? extends Object> getHasStar();

    /**
     * Checks if the class has a hasStar property value.<p>
     * 
     * @return true if there is a hasStar property value.
     */
    boolean hasHasStar();

    /**
     * Adds a hasStar property value.<p>
     * 
     * @param newHasStar the hasStar property value to be added
     */
    void addHasStar(Object newHasStar);

    /**
     * Removes a hasStar property value.<p>
     * 
     * @param oldHasStar the hasStar property value to be removed.
     */
    void removeHasStar(Object oldHasStar);
