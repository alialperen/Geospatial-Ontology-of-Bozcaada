...
public interface Beach extends CoastalLandForm {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/alperen/ontologies/2016/11/geolocation#BeachFlag
     */
     
    /**
     * Gets all property values for the BeachFlag property.<p>
     * 
     * @returns a collection of values for the BeachFlag property.
     */
    Collection<? extends String> getBeachFlag();

    /**
     * Checks if the class has a BeachFlag property value.<p>
     * 
     * @return true if there is a BeachFlag property value.
     */
    boolean hasBeachFlag();

    /**
     * Adds a BeachFlag property value.<p>
     * 
     * @param newBeachFlag the BeachFlag property value to be added
     */
    void addBeachFlag(String newBeachFlag);

    /**
     * Removes a BeachFlag property value.<p>
     * 
     * @param oldBeachFlag the BeachFlag property value to be removed.
     */
    void removeBeachFlag(String oldBeachFlag);
