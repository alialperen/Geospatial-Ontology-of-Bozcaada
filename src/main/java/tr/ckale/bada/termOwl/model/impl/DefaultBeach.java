 ...
 */
public class DefaultBeach extends WrappedIndividualImpl implements Beach {
    ...
    public Collection<? extends String> getBeachFlag() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_BEACHFLAG, String.class);
    }

    public boolean hasBeachFlag() {
		return !getBeachFlag().isEmpty();
    }

    public void addBeachFlag(String newBeachFlag) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_BEACHFLAG, newBeachFlag);
    }

    public void removeBeachFlag(String oldBeachFlag) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_BEACHFLAG, oldBeachFlag);
    }
