 ...
 * Source Class: Island <br>
 * @version generated on Wed Dec 21 09:21:50 MSK 2016 by Alperen
 */

public interface Island extends LandForm {
    ...
    /* ***************************************************
     * Property http://www.semanticweb.org/alperen/ontologies/2016/11/geolocation#area
     */
     
    /**
     * Gets all property values for the area property.<p>
     * 
     * @returns a collection of values for the area property.
     */
    Collection<? extends Object> getArea();

    /**
     * Checks if the class has a area property value.<p>
     * 
     * @return true if there is a area property value.
     */
    boolean hasArea();

    /**
     * Adds a area property value.<p>
     * 
     * @param newArea the area property value to be added
     */
    void addArea(Object newArea);

    /**
     * Removes a area property value.<p>
     * 
     * @param oldArea the area property value to be removed.
     */
    void removeArea(Object oldArea);
