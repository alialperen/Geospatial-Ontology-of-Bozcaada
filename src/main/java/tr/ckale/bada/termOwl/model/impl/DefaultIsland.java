 ...
 * Source Class: DefaultIsland <br>
 * @version generated on Wed Dec 21 09:21:50 MSK 2016 by Alperen
 */
public class DefaultIsland extends WrappedIndividualImpl implements Island {

    public DefaultIsland(CodeGenerationInference inference, IRI iri) {
        super(inference, iri);
    }
    ...
    public Collection<? extends Object> getArea() {
		return getDelegate().getPropertyValues(getOwlIndividual(), Vocabulary.DATA_PROPERTY_AREA, Object.class);
    }
    ...
    public void addArea(Object newArea) {
	    getDelegate().addPropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_AREA, newArea);
    }

    public void removeArea(Object oldArea) {
		getDelegate().removePropertyValue(getOwlIndividual(), Vocabulary.DATA_PROPERTY_AREA, oldArea);
    }
